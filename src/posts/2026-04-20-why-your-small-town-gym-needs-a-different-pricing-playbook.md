...
summary: You can't research the competition when you are the only gym in town.
  In a community where everyone knows your name, pricing is about reputation.
  Learn how to calculate your real member draw and raise rates without a riot
  using the "Grandfathering" strategy.
description: Stop copying big-box gym prices. Learn how to use the 15-minute
  catchment rule and "grandfathering" to build a profitable gym in a small town.
---
